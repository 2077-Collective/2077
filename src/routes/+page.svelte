...
<section class="hero px-6 lg:px-32 pt-64  min-h-screen">
    ...
    <p class="text-white font-interMedium text-xl text-gray-300">Nosotros somos el Colectivo 2077.</p>
    <p class="text-white font-interMedium text-xl text-gray-400">Wir sind das 2077 Kollektiv.</p>
