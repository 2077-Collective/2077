<section class="py-8 px-6 lg:px-20">
    <div class="container flex flex-col gap-y-16 pt-20 pb-32">
        ...
        <div class="flex flex-col gap-y-4">
            ...
            <p class="text-2xl max-w-screen-5xl">
                ...
                group, onboard, collaborate/coordinate with other individuals
                and work towards the goal of growing, educating, and promoting
                the Ethereum ecosystem. We believe Ethereum is technology for
                good and want to play a role in its adoption within and outside
                of crypto.
            </p>
        </div>
        <div class="flex flex-col gap-y-4">
            ...
            <p class="text-2xl max-w-screen-5xl">
                ...
                We're a creative studio, research shop, and mad science lab
                rolled into one—a place where talented people can come together
                to build, research, write, and create in ways that add value to
